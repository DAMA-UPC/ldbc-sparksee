...
namespace interactive {
    namespace update2{
        ...
        datatypes::Buffer Execute(gdb::Session *sess, long long person_id, long long post_id, long long creation_date) {
#ifdef VERBOSE
            printf("UPDATE QUERY2:\n");
#endif
            ...
            val.SetLong(post_id);
            gdb::oid_t post_oid = graph->FindObject(cache->post_id_t, val);
            gdb::oid_t edge_oid = graph->NewEdge(cache->likes_t, person_oid, post_oid);
